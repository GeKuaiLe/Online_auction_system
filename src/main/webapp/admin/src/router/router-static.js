...
import center from '@/views/center'
    ...
    import jingpaiweituo from '@/views/modules/jingpaiweituo/list'
    ...
    import chengjiaotongzhi from '@/views/modules/chengjiaotongzhi/list'
    ...
    import canyujingpai from '@/views/modules/canyujingpai/list'
...
const routes = [{
	...
	path: '/jingpaishangpin',
      ...
      ,{
	path: '/chengjiaotongzhi',
        name: '成交通知',
        component: chengjiaotongzhi
      }
      ,{
	path: '/yonghu',
        name: '用户',
