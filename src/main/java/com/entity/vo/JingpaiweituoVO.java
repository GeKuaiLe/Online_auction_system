 ...
 */
public class JingpaiweituoVO  implements Serializable {
	...
	public void setLixiangjiage(String lixiangjiage) {
		this.lixiangjiage = lixiangjiage;
	}
	
	/**
	 * 获取：理想价格
	 */
	public String getLixiangjiage() {
		return lixiangjiage;
	}
