...
public class JingpaishangpinModel  implements Serializable {
	...
	private String jingpaishuoming;
	...
	public void setJingpaishuoming(String jingpaishuoming) {
		this.jingpaishuoming = jingpaishuoming;
	}
	
	/**
	 * 获取：竞拍说明
	 */
	public String getJingpaishuoming() {
		return jingpaishuoming;
	}
